...
//            System.out.println(listOfMaps);
    ...
    public String insertMenu(String data) {                  //Static_Page 추가
        ...
        try {
            QueryRunner queryRunner = new QueryRunner();
            listOfMaps1=queryRunner.query(conn, "SELECT * FROM avocado_consol.menu_pages WHERE `tab_id`=?",new MapListHandler(),1);
    ...
    public String insertNoticeMenu(String data) {            //게시판 추가
        ...
        try {
            QueryRunner queryRunner = new QueryRunner();
            listOfMaps=queryRunner.query(conn, "SELECT * FROM avocado_consol.menu_pages WHERE `tab_id`=?",new MapListHandler(),2);
    ...
    public String insertIndependent(String data) {            //세부전공 메뉴 추가
        ...
        try {
            QueryRunner queryRunner = new QueryRunner();
            listOfMaps=queryRunner.query(conn, "SELECT * FROM avocado_consol.menu_pages WHERE `tab_id`=?",new MapListHandler(),5);
