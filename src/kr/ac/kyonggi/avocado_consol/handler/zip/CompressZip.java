package kr.ac.kyonggi.avocado_consol.handler.zip;
...
public class CompressZip {
     ...
     * @param zos 압축 스트림
     */
    private void searchDirectory(File file, String root, ZipOutputStream zos) throws Exception {// 지정된 파일이 디렉토리인지 파일인지 검색
...
//                System.out.println("file : "+file.getPath());
    ...
    private void compressZip(File file, String root, ZipOutputStream zos) throws Throwable {
        ...
        try {
            ...
            int read = 0;
            while((read=fis.read(buffer, 0, length))!=-1){
